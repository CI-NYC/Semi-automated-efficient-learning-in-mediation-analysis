...
agmm = RieszNetNonPrime(learner, moment_fn_1, moment_fn_2, moment_fn_3, a_1 = 1, a_2 = 1, a_3 = 1)
...
alpha_results.to_csv("/gpfs/home/ll4245/Projects/RieszLearning/results_111/N_%d_seq_%d.csv" % (N, int(label)))
