# Num: 7
# RDE in the recanting twins
# Contr of (1, 1, 0, 0) and (0, 0, 0, 0)
...
filename = paste0("~/Projects/RieszLearning/results_0000/N_", N, "_seq_", label, ".csv")
...
save(data, file=paste0("/gpfs/home/ll4245/Projects/RieszLearning/superlearner_7/", as.integer(Sys.getenv('SLURM_ARRAY_TASK_ID')),".RData"))