...
filename = paste0("~/Projects/RieszLearning/results_00/N_", N, "_seq_", label, ".csv")
...
save(data, file=paste0("/gpfs/home/ll4245/Projects/RieszLearning/superlearner_8/", as.integer(Sys.getenv('SLURM_ARRAY_TASK_ID')),".RData"))
