...
agmm = RieszNetPrime(learner, moment_fn_1, moment_fn_2, moment_fn_3, moment_fn_4, moment_fn_5, moment_fn_6, a_1 = 1, a_2 = 1, a_3 = 1, a_4 = 1)
...
alpha_results.to_csv("/gpfs/home/ll4245/Projects/RieszLearning/results_1111/N_%d_seq_%d.csv" % (N, int(label)))
