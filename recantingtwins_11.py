...
agmm = RieszNetNDE(learner, moment_fn_1, moment_fn_2, a_1 = 1, a_2 = 1)
...
alpha_results.to_csv("/gpfs/home/ll4245/Projects/RieszLearning/results_11/N_%d_seq_%d.csv" % (N, int(label)))
