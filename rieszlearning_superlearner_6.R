# Num: 6
# RIE in the recanting twins
# Contr of (1, 1, 1, 1) and (1, 1, 0, 0)
...
filename = paste0("~/Projects/RieszLearning/results_1100/N_", N, "_seq_", label, ".csv")
...
filename = paste0("~/Projects/RieszLearning/results_1111/N_", N, "_seq_", label, ".csv")
combined_alpha_results_RDE_RIE_cont_M_cont_Z_a_10 <- read_csv(filename)
...
save(data, file=paste0("/gpfs/home/ll4245/Projects/RieszLearning/superlearner_6/", as.integer(Sys.getenv('SLURM_ARRAY_TASK_ID')),".RData"))