# Num: 2
# Path 2 in the recanting twins
# Contr of (0, 1, 1, 1) and (0, 0, 1, 1)
# True value in the case (0.4, 0.6, 0.6, 0.4): 0.016128
...
save(data, file=paste0("/gpfs/home/ll4245/Projects/RieszLearning/superlearner_2/", as.integer(Sys.getenv('SLURM_ARRAY_TASK_ID')),".RData"))